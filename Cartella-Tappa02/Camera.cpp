...
glm::mat4 Camera::GetViewMatrix() {
    ...
    // Parametri: (Posizione occhio, Punto osservato, Vettore Up)
...
void Camera::ProcessMouseMovement(float xoffset, float yoffset) {
    ...
    // Constraint di sicurezza (Prevenzione del ribaltamento)
...
void Camera::updateCameraVectors() {
    ...
    // La normalizzazione è indispensabile per mantenere il vettore di lunghezza 1 
